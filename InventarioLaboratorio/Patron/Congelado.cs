...
namespace InventarioLaboratorio.Patron
{
    class Congelado : ReactivoInfo
    {
        ...
        public Congelado( string Nombre, string Numero, string Clasificacion, string Laboratorio, string Caducidad, string Catalogo, string Unidad, string Observacion)
        {
    ...
    class FCongelador : ReactivoFabrica
    {
        ...
        public FCongelador( string nombre, string numero, string clasificacion, string laboratorio, string caducidad, string catalogo, string unidad, string observacion)
        {
        ...
        {
            return new Congelado( Nombre, Numero, Clasificacion, Laboratorio, Caducidad, Catalogo, Unidad, Observacion);
